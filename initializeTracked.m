...
M.tracked.tum_num_targeting = zeros(1,4); % tracks number of CTLs targeting this cell (0,1,2,3+)
...
if M.save_pars.track_drug_concentrations
    M.tracked.fgfr3_region_concentrations = zeros(1,M.fgfr3.n_regions);
    M.tracked.fgfr3_circulation_concentration(M.i) = 0;
    M.tracked.apd1_region_concentrations(M.i,:) = zeros(1,M.checkpoint.n_regions);
    M.tracked.apd1_circulation_concentration(M.i) = 0;
end