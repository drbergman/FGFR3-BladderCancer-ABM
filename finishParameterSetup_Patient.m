...
switch M.immune_pars.deactivation_function_type
    case "pd1_hill"
        M.immune_pars.deactivation_function = @(pd1_factor,M) M.immune_pars.deactivation_rate_pd1 * pd1_factor./(1+pd1_factor);
end

M.immune_pars.is_exhausted_apoptosis_rate_different = isfield(M.immune_pars,"apop_rate_exhausted") && M.immune_pars.apop_rate_exhausted~=M.immune_pars.apop_rate;
...
M.checkpoint.pd1_on_immune = (M.checkpoint.pd1_on_immune_nmols ...
    /M.pars.V)... % divide by total volume of reaction space to get concentration of PD1 in nmol/um^3
    *1e15; % multiply by 1e15um^3/L to get concentration of PD1 in nM
