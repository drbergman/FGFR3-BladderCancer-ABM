...
%% pd1 parameters
checkpoint.pd1_on_immune_nmols = ((3096 ... % mean number of PD1 on a CTL Cheng, Xiaoxiao, et al. "Structure and interactions of the human programmed cell death 1 receptor." Journal of Biological Chemistry 288.17 (2013): 11771-11785.
...
%% apd1 parameters
checkpoint.diffusivity_apd1 = 10 * 60; % diffusion coefficient for anti-pd1 (um^2/min) (from Thurber paper)
checkpoint.degradation_apd1 = 1 / 1440; % degradation rate for anti-pd1
checkpoint.systemic_elimination_apd1 = log(2)/(3*1440); % systemic elimination rate for anti-pd1 in mouse

%% apdl1 parameters
checkpoint.diffusivity_apdl1 = 10 * 60; % diffusion coefficient for anti-pd1 (um^2/min) (from Thurber paper)
checkpoint.degradation_apdl1 = 1 / 1440; % degradation rate for anti-pdl1
checkpoint.systemic_elimination_apdl1 = 0; % not using apdl1 yet

%% reaction parameters

checkpoint.kf_pd1_pdl1 = 100 / 1440;
checkpoint.kr_pd1_pdl1 = 8.2e5 / 1440;

checkpoint.kf_pd1_apd1 = 1e3 / 1440;
checkpoint.kr_pd1_apd1 = 1.45e3 / 1440;
...
checkpoint.influx_apd1 = (log(2)/(32.5/24)) / 1440; % rate of influx of anti-pd1 into TME (the log(2)/(32.5/24) value is from Bajaj (above) where they say the distribution phase half life is 32.5 h.
