...
I.tumor_num_targeting = I.region_checkpoint + 3;
I.tumor_mut = I.region_checkpoint + 4;
I.tumor_receptors = I.region_checkpoint + (5:10); % column indices in which the receptor information is stored (always have these be the last)
